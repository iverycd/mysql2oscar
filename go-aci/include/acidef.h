...
#define OCIParamSet                   ACIParamSet
...
#define OCIXMLTypeCreateFromSrc		  ACIXMLTypeCreateFromSrc
...
#define OCIContextClearValue			ACIContextClearValue
#define OCIContextGenerateKey			ACIContextGenerateKey
#define OCIContextGetValue				ACIContextGetValue
#define OCIContextSetValue				ACIContextSetValue

#define OCIExtractFromFile				ACIExtractFromFile
#define OCIExtractFromList				ACIExtractFromList
#define OCIExtractFromStr				ACIExtractFromStr
#define OCIExtractInit					ACIExtractInit
#define OCIExtractReset					ACIExtractReset
#define OCIExtractSetKey				ACIExtractSetKey
#define OCIExtractSetNumKeys			ACIExtractSetNumKeys
#define OCIExtractTerm					ACIExtractTerm
#define OCIExtractToBool				ACIExtractToBool
#define OCIExtractToInt					ACIExtractToInt
#define OCIExtractToList				ACIExtractToList
#define OCIExtractToOCINum				ACIExtractToOCINum
#define OCIExtractToStr					ACIExtractToStr
...
#define OCIResultSetToStmt				ACIResultSetToStmt
//DCIdefine:
...
#define OCISvcCtxToLda					ACISvcCtxToLda
#define OCILdaToSvcCtx					ACILdaToSvcCtx
...
#define OCIFileObject		  ACIFileObject
...
*/
#define OCIExtProcContext	  ACIExtProcContext
...
#define OCI_ATTR_VERSION			  ACI_ATTR_VERSION
...
#define OCI_ATTR_XID				  ACI_ATTR_XID
#define OCI_ATTR_TRANS_LOCK			  ACI_ATTR_TRANS_LOCK
#define OCI_ATTR_TRANS_NAME			  ACI_ATTR_TRANS_NAME
#define OCI_ATTR_HEAPALLOC			  ACI_ATTR_HEAPALLOC
#define OCI_ATTR_CACHE_OPT_SIZE		  ACI_ATTR_CACHE_OPT_SIZE
#define OCI_ATTR_CACHE_MAX_SIZE		  ACI_ATTR_CACHE_MAX_SIZE
#define OCI_ATTR_PINOPTION			  ACI_ATTR_PINOPTION
#define OCI_ATTR_ALLOC_DURATION		  ACI_ATTR_ALLOC_DURATION
#define OCI_ATTR_PIN_DURATION		  ACI_ATTR_PIN_DURATION
#define OCI_ATTR_PIN_DURATION		  ACI_ATTR_PIN_DURATION
#define OCI_ATTR_FDO				  ACI_ATTR_FDO
#define OCI_ATTR_POSTPROCESSING_CALLBACK ACI_ATTR_POSTPROCESSING_CALLBACK
#define OCI_ATTR_POSTPROCESSING_CONTEXT ACI_ATTR_POSTPROCESSING_CONTEXT
#define OCI_SYSASM					  ACI_SYSASM
#define OCI_OPCODE_ALLOPS			  ACI_OPCODE_ALLOPS
#define OCI_OPCODE_ALLROWS			  ACI_OPCODE_ALLROWS
#define OCI_OPCODE_INSERT			  ACI_OPCODE_INSERT
#define OCI_OPCODE_UPDATE			  ACI_OPCODE_UPDATE
#define OCI_OPCODE_DELETE			  ACI_OPCODE_DELETE
#define OCI_OPCODE_ALTER			  ACI_OPCODE_ALTER
#define OCI_OPCODE_DROP				  ACI_OPCODE_DROP
#define OCI_SESSGET_CREDPROXY		  ACI_SESSGET_CREDPROXY
#define OCI_SESSGET_CREDEXT			  ACI_SESSGET_CREDEXT
#define OCI_ATTR_CLIENT_IDENTIFIER	  ACI_ATTR_CLIENT_IDENTIFIER
#define OCI_ATTR_APPCTX_SIZE		  ACI_ATTR_APPCTX_SIZE
#define OCI_ATTR_APPCTX_LIST		  ACI_ATTR_APPCTX_LIST
#define OCI_ATTR_APPCTX_NAME		  ACI_ATTR_APPCTX_NAME
#define OCI_ATTR_APPCTX_ATTR		  ACI_ATTR_APPCTX_ATTR
#define OCI_ATTR_APPCTX_VALUE		  ACI_ATTR_APPCTX_VALUE
...
#define OCINumberPrec				  ACINumberPrec
...
//Error Return Values For  External Procedure
#define OCIEXTPROC_SUCCESS				ACIEXTPROC_SUCCESS
#define OCIEXTPROC_ERROR				ACIEXTPROC_ERROR
...
#define OCI_RESERVED1					ACI_RESERVED1
#define OCI_SHARED						ACI_SHARED
#define OCI_RESERVED2				 ACI_RESERVED2
/* The following *TWO* are only valid for ACICreateEnvironment call */
#define OCI_NO_UCB						ACI_NO_UCB
#define OCI_NO_MUTEX					ACI_NO_MUTEX
#define OCI_SHARED_EXT					ACI_SHARED_EXT
/************************** 0x00000200 free **********************************/
#define OCI_ALWAYS_BLOCKING				ACI_ALWAYS_BLOCKING
/************************** 0x00000800 free **********************************/
#define OCI_USE_LDAP					ACI_USE_LDAP
#define OCI_REG_LDAPONLY				ACI_REG_LDAPONLY
#define OCI_UTF16						ACI_UTF16
#define OCI_AFC_PAD_ON					ACI_AFC_PAD_ON
#define OCI_ENVCR_RESERVED3				ACI_ENVCR_RESERVED3
#define OCI_NEW_LENGTH_SEMANTICS		ACI_NEW_LENGTH_SEMANTICS
       /* the new length semantics, always bytes, is used by ACIEnvNlsCreate */
#define OCI_NO_MUTEX_STMT				ACI_NO_MUTEX_STMT
#define OCI_MUTEX_ENV_ONLY				ACI_MUTEX_ENV_ONLY
#define OCI_STM_RESERVED4				ACI_STM_RESERVED4
#define OCI_MUTEX_TRY					ACI_MUTEX_TRY
#define OCI_NCHAR_LITERAL_REPLACE_ON	ACI_NCHAR_LITERAL_REPLACE_ON
#define OCI_NCHAR_LITERAL_REPLACE_OFF	ACI_NCHAR_LITERAL_REPLACE_OFF
#define OCI_SRVATCH_RESERVED5			ACI_SRVATCH_RESERVED5
...
#define OCI_PARSE_ONLY	              ACI_PARSE_ONLY
#define OCI_EXACT_FETCH_RESERVED_1	  ACI_EXACT_FETCH_RESERVED_1
#define OCI_SHOW_DML_WARNINGS		  ACI_SHOW_DML_WARNINGS

#define OCI_COMMIT_ON_SUCCESS         ACI_COMMIT_ON_SUCCESS
#define OCI_NON_BLOCKING			  ACI_NON_BLOCKING
...
#define OCI_ATTR_SESSLANG			  ACI_ATTR_SESSLANG
#define OCI_ATTR_VISIBILITY           ACI_ATTR_VISIBILITY
#define OCI_ATTR_RELATIVE_MSGID       ACI_ATTR_RELATIVE_MSGID
#define OCI_ATTR_SEQUENCE_DEVIATION   ACI_ATTR_SEQUENCE_DEVIATION
#define OCI_ATTR_CONSUMER_NAME        ACI_ATTR_CONSUMER_NAME
#define OCI_ATTR_DEQ_MODE             ACI_ATTR_DEQ_MODE
#define OCI_ATTR_NAVIGATION           ACI_ATTR_NAVIGATION
#define OCI_ATTR_WAIT                 ACI_ATTR_WAIT
#define OCI_ATTR_DEQ_MSGID            ACI_ATTR_DEQ_MSGID
#define OCI_ATTR_PRIORITY             ACI_ATTR_PRIORITY
#define OCI_ATTR_DELAY                ACI_ATTR_DELAY
#define OCI_ATTR_EXPIRATION           ACI_ATTR_EXPIRATION
#define OCI_ATTR_CORRELATION          ACI_ATTR_CORRELATION
#define OCI_ATTR_ATTEMPTS             ACI_ATTR_ATTEMPTS
#define OCI_ATTR_RECIPIENT_LIST       ACI_ATTR_RECIPIENT_LIST
#define OCI_ATTR_EXCEPTION_QUEUE      ACI_ATTR_EXCEPTION_QUEUE
#define OCI_ATTR_ENQ_TIME             ACI_ATTR_ENQ_TIME
#define OCI_ATTR_MSG_STATE            ACI_ATTR_MSG_STATE
#define OCI_ATTR_AGENT_NAME           ACI_ATTR_AGENT_NAME
#define OCI_ATTR_AGENT_ADDRESS        ACI_ATTR_AGENT_ADDRESS
#define OCI_ATTR_AGENT_PROTOCOL       ACI_ATTR_AGENT_PROTOCOL
#define OCI_ATTR_USER_PROPERTY        ACI_ATTR_USER_PROPERTY
#define OCI_ATTR_SENDER_ID            ACI_ATTR_SENDER_ID
#define OCI_ATTR_ORIGINAL_MSGID       ACI_ATTR_ORIGINAL_MSGID
#define OCI_ATTR_QUEUE_NAME           ACI_ATTR_QUEUE_NAME
#define OCI_ATTR_NFY_MSGID            ACI_ATTR_NFY_MSGID
#define OCI_ATTR_MSG_PROP             ACI_ATTR_MSG_PROP
#define OCI_ATTR_BUF_ADDR             ACI_ATTR_BUF_ADDR
#define OCI_ATTR_IS_TEMPORARY		  ACI_ATTR_IS_TEMPORARY
...
#define OCI_ATTR_DESC_PUBLIC          ACI_ATTR_DESC_PUBLIC
#define OCI_ATTR_SHOW_INVISIBLE_COLUMNS ACI_ATTR_SHOW_INVISIBLE_COLUMNS 
...
#define OCI_ATTR_DISP_SIZE            ACI_ATTR_DISP_SIZE
...
#define OCI_ATTR_CHARSET			  ACI_ATTR_CHARSET
#define OCI_ATTR_NCHAR				  ACI_ATTR_NCHAR
...
#define OCI_ATTR_ACTION                     ACI_ATTR_ACTION
#define OCI_ATTR_CLIENT_INFO                ACI_ATTR_CLIENT_INFO
#define OCI_ATTR_COLLECT_CALL_TIME          ACI_ATTR_COLLECT_CALL_TIME
#define OCI_ATTR_CALL_TIME                  ACI_ATTR_CALL_TIME
#define OCI_ATTR_ECONTEXT_ID                ACI_ATTR_ECONTEXT_ID
#define OCI_ATTR_ECONTEXT_SEQ               ACI_ATTR_ECONTEXT_SEQ

/*------------------------------ Session attributes -------------------------*/
#define OCI_ATTR_SESSION_STATE              ACI_ATTR_SESSION_STATE
#define OCI_SESSION_STATELESS				ACI_SESSION_STATELESS
#define OCI_SESSION_STATEFUL				ACI_SESSION_STATEFUL
#define OCI_ATTR_SESSION_STATETYPE          ACI_ATTR_SESSION_STATETYPE
#define OCI_SESSION_STATELESS_DEF			ACI_SESSION_STATELESS_DEF
#define OCI_SESSION_STATELESS_CAL			ACI_SESSION_STATELESS_CAL
#define OCI_SESSION_STATELESS_TXN			ACI_SESSION_STATELESS_TXN
#define OCI_SESSION_STATELESS_APP			ACI_SESSION_STATELESS_APP
#define OCI_ATTR_SESSION_STATE_CLEARED      ACI_ATTR_SESSION_STATE_CLEARED
#define OCI_ATTR_SESSION_MIGRATED           ACI_ATTR_SESSION_MIGRATED
#define OCI_ATTR_SESSION_PRESERVE_STATE     ACI_ATTR_SESSION_PRESERVE_STATE
...
#define OCI_ATTR_DBDOMAIN			  ACI_ATTR_DBDOMAIN
...
#define OCI_ATTR_POSITION			  ACI_ATTR_POSITION
...
#define OCI_ATTR_INSTSTARTTIME		  ACI_ATTR_INSTSTARTTIME
#define OCI_ATTR_SERVICENAME		  ACI_ATTR_SERVICENAME
#define OCI_ATTR_FNCODE				  ACI_ATTR_FNCODE
#define OCI_ATTR_OBJECT				  ACI_ATTR_OBJECT
#define OCI_ATTR_SQLCODE			  ACI_ATTR_SQLCODE
#define OCI_ATTR_SQLFNCODE			  ACI_ATTR_SQLFNCODE
#define OCI_ATTR_NESTED_PREFETCH_ROWS ACI_ATTR_NESTED_PREFETCH_ROWS
#define OCI_ATTR_NESTED_PREFETCH_MEMORY	ACI_ATTR_NESTED_PREFETCH_MEMORY
#define OCI_ATTR_CHAR_COUNT			  ACI_ATTR_CHAR_COUNT
#define OCI_ATTR_PDSCL				  ACI_ATTR_PDSCL
#define OCI_ATTR_PDPRC				  ACI_ATTR_PDPRC
...
#define OCI_ATTR_STREAM_OFFSET			ACI_ATTR_STREAM_OFFSET
#define OCI_ATTR_SHARED_HEAPALLOC		ACI_ATTR_SHARED_HEAPALLOC
#define OCI_ATTR_MIGSESSION				ACI_ATTR_MIGSESSION
#define OCI_ATTR_MEMPOOL_SIZE			ACI_ATTR_MEMPOOL_SIZE
#define OCI_ATTR_MEMPOOL_INSTNAME		ACI_ATTR_MEMPOOL_INSTNAME
#define OCI_ATTR_MEMPOOL_APPNAME		ACI_ATTR_MEMPOOL_APPNAME
#define OCI_ATTR_MEMPOOL_HOMENAME		ACI_ATTR_MEMPOOL_HOMENAME
#define OCI_ATTR_MEMPOOL_MODEL			ACI_ATTR_MEMPOOL_MODEL
#define OCI_ATTR_MODES					ACI_ATTR_MODES\

#define OCI_ATTR_SUBSCR_NAME			ACI_ATTR_SUBSCR_NAME
#define OCI_ATTR_SUBSCR_CALLBACK		ACI_ATTR_SUBSCR_CALLBACK
#define OCI_ATTR_SUBSCR_PAYLOAD			ACI_ATTR_SUBSCR_PAYLOAD
#define OCI_ATTR_SUBSCR_CTX				ACI_ATTR_SUBSCR_CTX
#define OCI_ATTR_SUBSCR_NAMESPACE		ACI_ATTR_SUBSCR_NAMESPACE
#define OCI_ATTR_PROXY_CREDENTIALS		ACI_ATTR_PROXY_CREDENTIALS
#define OCI_ATTR_INITIAL_CLIENT_ROLES	ACI_ATTR_INITIAL_CLIENT_ROLES

#define OCI_ATTR_UNK              			ACI_ATTR_UNK                
#define OCI_ATTR_NUM_COLS                   ACI_ATTR_NUM_COLS           
#define OCI_ATTR_LIST_COLUMNS               ACI_ATTR_LIST_COLUMNS       
#define	OCI_ATTR_RDBA                       ACI_ATTR_RDBA               
#define OCI_ATTR_CLUSTERED                  ACI_ATTR_CLUSTERED          
#define	OCI_ATTR_PARTITIONED                ACI_ATTR_PARTITIONED        
#define OCI_ATTR_INDEX_ONLY                 ACI_ATTR_INDEX_ONLY         
#define OCI_ATTR_LIST_ARGUMENTS             ACI_ATTR_LIST_ARGUMENTS     
#define OCI_ATTR_LIST_SUBPROGRAMS           ACI_ATTR_LIST_SUBPROGRAMS   
#define OCI_ATTR_REF_TDO                    ACI_ATTR_REF_TDO            
#define OCI_ATTR_LINK                       ACI_ATTR_LINK               
#define OCI_ATTR_MIN                        ACI_ATTR_MIN                
#define OCI_ATTR_MAX                        ACI_ATTR_MAX                
#define OCI_ATTR_INCR                      	ACI_ATTR_INCR               
#define OCI_ATTR_CACHE                      ACI_ATTR_CACHE              
#define OCI_ATTR_ORDER                      ACI_ATTR_ORDER              
#define OCI_ATTR_HW_MARK                    ACI_ATTR_HW_MARK            
#define OCI_ATTR_TYPE_SCHEMA                ACI_ATTR_TYPE_SCHEMA        
#define OCI_ATTR_TIMESTAMP                  ACI_ATTR_TIMESTAMP          
#define OCI_ATTR_NUM_ATTRS                  ACI_ATTR_NUM_ATTRS          
#define OCI_ATTR_NUM_PARAMS                 ACI_ATTR_NUM_PARAMS         
#define OCI_ATTR_OBJID                      ACI_ATTR_OBJID              
#define OCI_ATTR_PTYPE                      ACI_ATTR_PTYPE              
#define OCI_ATTR_PARAM                      ACI_ATTR_PARAM              
#define OCI_ATTR_OVERLOAD_ID                ACI_ATTR_OVERLOAD_ID        
#define OCI_ATTR_TABLESPACE                 ACI_ATTR_TABLESPACE         
#define OCI_ATTR_TDO                        ACI_ATTR_TDO                
#define OCI_ATTR_LTYPE                      ACI_ATTR_LTYPE              
#define OCI_ATTR_PARSE_ERROR_OFFSET         ACI_ATTR_PARSE_ERROR_OFFSET       
#define OCI_ATTR_IS_TYPED                   ACI_ATTR_IS_TYPED           
#define OCI_ATTR_DURATION                   ACI_ATTR_DURATION           
#define OCI_ATTR_IS_INVOKER_RIGHTS          ACI_ATTR_IS_INVOKER_RIGHTS  
#define OCI_ATTR_OBJ_NAME                   ACI_ATTR_OBJ_NAME           
#define OCI_ATTR_OBJ_SCHEMA                 ACI_ATTR_OBJ_SCHEMA         
#define OCI_ATTR_OBJ_ID                     ACI_ATTR_OBJ_ID  
#define OCI_ATTR_LIST_PKG_TYPES             ACI_ATTR_LIST_PKG_TYPES


/* For values 137 - 141, see DirPathAPI attribute section in this file */


#define OCI_ATTR_TRANS_TIMEOUT              ACI_ATTR_TRANS_TIMEOUT
#define OCI_ATTR_SERVER_STATUS              ACI_ATTR_SERVER_STATUS
#define OCI_ATTR_STATEMENT                  ACI_ATTR_STATEMENT
/* For value 145, see DirPathAPI attribute section in this file */

#define OCI_ATTR_DEQCOND                    ACI_ATTR_DEQCOND
#define OCI_ATTR_RESERVED_2                 ACI_ATTR_RESERVED_2


#define OCI_ATTR_SUBSCR_RECPT               ACI_ATTR_SUBSCR_RECPT
#define OCI_ATTR_SUBSCR_RECPTPROTO          ACI_ATTR_SUBSCR_RECPTPROTO

/* For values 150 - 151, see DirPathAPI attribute section in this file */

#define OCI_ATTR_LDAP_HOST       ACI_ATTR_LDAP_HOST
#define OCI_ATTR_LDAP_PORT       ACI_ATTR_LDAP_PORT
#define OCI_ATTR_BIND_DN         ACI_ATTR_BIND_DN
#define OCI_ATTR_LDAP_CRED       ACI_ATTR_LDAP_CRED
#define OCI_ATTR_WALL_LOC        ACI_ATTR_WALL_LOC
#define OCI_ATTR_WALL_PWD		 ACI_ATTR_WALL_PWD
#define OCI_ATTR_WALL_CIPHERLIST ACI_ATTR_WALL_CIPHERLIST
#define OCI_ATTR_LDAP_AUTH       ACI_ATTR_LDAP_AUTH
#define OCI_ATTR_OS_AUTH         ACI_ATTR_OS_AUTH
#define OCI_ATTR_LDAP_CTX        ACI_ATTR_LDAP_CTX
#define OCI_ATTR_SERVER_DNS      ACI_ATTR_SERVER_DNS

#define OCI_ATTR_DN_COUNT        ACI_ATTR_DN_COUNT
#define OCI_ATTR_SERVER_DN       ACI_ATTR_SERVER_DN
...
#define OCI_ATTR_RESERVED_3                 ACI_ATTR_RESERVED_3
#define OCI_ATTR_RESERVED_4                 ACI_ATTR_RESERVED_4

/* For value 167, see DirPathAPI attribute section in this file */

#define OCI_ATTR_DIGEST_ALGO                ACI_ATTR_DIGEST_ALGO
#define OCI_ATTR_CERTIFICATE                ACI_ATTR_CERTIFICATE
#define OCI_ATTR_SIGNATURE_ALGO             ACI_ATTR_SIGNATURE_ALGO
#define OCI_ATTR_CANONICAL_ALGO             ACI_ATTR_CANONICAL_ALGO
#define OCI_ATTR_PRIVATE_KEY                ACI_ATTR_PRIVATE_KEY
#define OCI_ATTR_DIGEST_VALUE               ACI_ATTR_DIGEST_VALUE
#define OCI_ATTR_SIGNATURE_VAL              ACI_ATTR_SIGNATURE_VAL
#define OCI_ATTR_SIGNATURE                  ACI_ATTR_SIGNATURE

#define OCI_ATTR_HANDLE_POSITION			ACI_ATTR_HANDLE_POSITION
#define OCI_ATTR_RESERVED_5					ACI_ATTR_RESERVED_5
#define OCI_ATTR_SERVER_BUSY				ACI_ATTR_SERVER_BUSY


/* ------------ - Supported Values for Direct Path Stream Version------------ - */
#define OCI_DIRPATH_STREAM_VERSION_1        ACI_DIRPATH_STREAM_VERSION_1
#define OCI_DIRPATH_STREAM_VERSION_2        ACI_DIRPATH_STREAM_VERSION_2
#define OCI_DIRPATH_STREAM_VERSION_3        ACI_DIRPATH_STREAM_VERSION_3

#define OCI_ATTR_DIRPATH_MODE				ACI_ATTR_DIRPATH_MODE
#define OCI_ATTR_DIRPATH_NOLOG				ACI_ATTR_DIRPATH_NOLOG
#define OCI_ATTR_DIRPATH_PARALLEL			ACI_ATTR_DIRPATH_PARALLEL

#define OCI_ATTR_DIRPATH_SORTED_INDEX		ACI_ATTR_DIRPATH_SORTED_INDEX
#define OCI_ATTR_DIRPATH_INDEX_MAINT_METHOD ACI_ATTR_DIRPATH_INDEX_MAINT_METHOD
#define OCI_ATTR_DIRPATH_FILE               ACI_ATTR_DIRPATH_FILE
#define OCI_ATTR_DIRPATH_STORAGE_INITIAL    ACI_ATTR_DIRPATH_STORAGE_INITIAL
#define OCI_ATTR_DIRPATH_STORAGE_NEXT       ACI_ATTR_DIRPATH_STORAGE_NEXT
#define OCI_ATTR_DIRPATH_SKIPINDEX_METHOD   ACI_ATTR_DIRPATH_SKIPINDEX_METHOD
#define OCI_ATTR_DIRPATH_EXPR_TYPE			ACI_ATTR_DIRPATH_EXPR_TYPE

/*------------- Supported Values for Direct Path Date cache -----------------*/
#define OCI_ATTR_DIRPATH_DCACHE_NUM         ACI_ATTR_DIRPATH_DCACHE_NUM
#define OCI_ATTR_DIRPATH_DCACHE_SIZE        ACI_ATTR_DIRPATH_DCACHE_SIZE
#define OCI_ATTR_DIRPATH_DCACHE_MISSES      ACI_ATTR_DIRPATH_DCACHE_MISSES
#define OCI_ATTR_DIRPATH_DCACHE_HITS        ACI_ATTR_DIRPATH_DCACHE_HITS
#define OCI_ATTR_DIRPATH_DCACHE_DISABLE     ACI_ATTR_DIRPATH_DCACHE_DISABLE
#define OCI_ATTR_DIRPATH_RESERVED_7         ACI_ATTR_DIRPATH_RESERVED_7
#define OCI_ATTR_DIRPATH_RESERVED_8         ACI_ATTR_DIRPATH_RESERVED_8
#define OCI_ATTR_DIRPATH_CONVERT            ACI_ATTR_DIRPATH_CONVERT
#define OCI_ATTR_DIRPATH_BADROW             ACI_ATTR_DIRPATH_BADROW
#define OCI_ATTR_DIRPATH_BADROW_LENGTH      ACI_ATTR_DIRPATH_BADROW_LENGTH
#define OCI_ATTR_DIRPATH_WRITE_ORDER        ACI_ATTR_DIRPATH_WRITE_ORDER
#define OCI_ATTR_DIRPATH_GRANULE_SIZE       ACI_ATTR_DIRPATH_GRANULE_SIZE
#define OCI_ATTR_DIRPATH_GRANULE_OFFSET     ACI_ATTR_DIRPATH_GRANULE_OFFSET
#define OCI_ATTR_DIRPATH_RESERVED_1         ACI_ATTR_DIRPATH_RESERVED_1
#define OCI_ATTR_DIRPATH_RESERVED_2         ACI_ATTR_DIRPATH_RESERVED_2

/*------ Attributes for 10i DirPathAPI conversion (NLS lang, terr, cs) ------*/
#define OCI_ATTR_DIRPATH_RESERVED_3         ACI_ATTR_DIRPATH_RESERVED_3
#define OCI_ATTR_DIRPATH_RESERVED_4         ACI_ATTR_DIRPATH_RESERVED_4
#define OCI_ATTR_DIRPATH_RESERVED_5         ACI_ATTR_DIRPATH_RESERVED_5
#define OCI_ATTR_DIRPATH_RESERVED_6         ACI_ATTR_DIRPATH_RESERVED_6

#define OCI_ATTR_DIRPATH_LOCK_WAIT          ACI_ATTR_DIRPATH_LOCK_WAIT

/* --------------------------- Snapshot attributes ------------------------- */
#define OCI_ATTR_SCN_BASE                   ACI_ATTR_SCN_BASE
#define OCI_ATTR_SCN_WRAP                   ACI_ATTR_SCN_WRAP

/* --------------------------- Miscellanous attributes --------------------- */
#define OCI_ATTR_RESERVED_6                ACI_ATTR_RESERVED_6
#define OCI_ATTR_READONLY_TXN              ACI_ATTR_READONLY_TXN
#define OCI_ATTR_RESERVED_7                ACI_ATTR_RESERVED_7
#define OCI_ATTR_ERRONEOUS_COLUMN          ACI_ATTR_ERRONEOUS_COLUMN
#define OCI_ATTR_RESERVED_8                ACI_ATTR_RESERVED_8

/* For value 206, see DirPathAPI attribute section in this file */

#define OCI_ATTR_INST_TYPE                  ACI_ATTR_INST_TYPE
#define OCI_ATTR_SPOOL_STMTCACHESIZE        ACI_ATTR_SPOOL_STMTCACHESIZE
#define OCI_ATTR_ENV_UTF16                  ACI_ATTR_ENV_UTF16

/*Only Stored Procs */
#define OCI_ATTR_RESERVED_9                ACI_ATTR_RESERVED_9
#define OCI_ATTR_OVERLOAD                  ACI_ATTR_OVERLOAD
#define OCI_ATTR_RESERVED_10               ACI_ATTR_RESERVED_10
#define OCI_ATTR_LEVEL                     ACI_ATTR_LEVEL
#define OCI_ATTR_HAS_DEFAULT               ACI_ATTR_HAS_DEFAULT
#define OCI_ATTR_IOMODE                    ACI_ATTR_IOMODE
...
#define OCI_ATTR_RESERVED_12    ACI_ATTR_RESERVED_12
#define OCI_ATTR_RADIX          ACI_ATTR_RADIX
#define OCI_ATTR_RESERVED_13    ACI_ATTR_RESERVED_13
/*--------------------------- soda ---------------------------------------*/
...
#define OCI_DTYPE_RSET				  ACI_DTYPE_RSET
...
#define	OCIResult					  ACIResult
#define	OCISubscription				  ACISubscription
...
#define OCI_SB2_IND_PTR			ACI_SB2_IND_PTR
#define OCI_DATA_AT_EXEC		ACI_DATA_AT_EXEC
#define OCI_DYNAMIC_FETCH		ACI_DYNAMIC_FETCH
#define OCI_PIECEWISE			ACI_PIECEWISE
#define OCI_DEFINE_RESERVED_1	ACI_DEFINE_RESERVED_1
#define OCI_BIND_RESERVED_2		ACI_BIND_RESERVED_2
#define OCI_DEFINE_RESERVED_2	ACI_DEFINE_RESERVED_2
#define OCI_BIND_SOFT			ACI_BIND_SOFT
#define OCI_DEFINE_SOFT			ACI_DEFINE_SOFT
#define OCI_BIND_RESERVED_3		ACI_BIND_RESERVED_3
/*---------------------------------------------------------------------------*/
...
#define OCI_LOGON2_PROXY       ACI_LOGON2_PROXY
/*---------------------------------------------------------------------------*/
...
#define OCI_ATTR_DIRPATH_FN_CTX         ACI_ATTR_DIRPATH_FN_CTX
#define OCI_ATTR_DIRPATH_OID			ACI_ATTR_DIRPATH_OID
#define OCI_ATTR_DIRPATH_SID		    ACI_ATTR_DIRPATH_SID
#define OCI_ATTR_DIRPATH_OBJ_CONSTR		ACI_ATTR_DIRPATH_OBJ_CONSTR
#define OCI_ATTR_DIRPATH_STREAM_VERSION ACI_ATTR_DIRPATH_STREAM_VERSION
#define OCI_ATTR_NUM_OPEN_STMTS         ACI_ATTR_NUM_OPEN_STMTS
#define OCI_ATTR_RESERVED_189           ACI_ATTR_RESERVED_189
#define OCI_ATTR_DESCRIBE_NATIVE        ACI_ATTR_DESCRIBE_NATIVE
/*-------------------------------------------------------------------------*/

/* notification presentation for recipient */
#define OCI_ATTR_SUBSCR_RECPTPRES           ACI_ATTR_SUBSCR_RECPTPRES
#define OCI_ATTR_TRANSFORMATION             ACI_ATTR_TRANSFORMATION
...
/*------------------------ Fail Over Events ---------------------------------*/
#define OCI_FO_END          ACI_FO_END 
#define OCI_FO_ABORT        ACI_FO_ABORT 
#define OCI_FO_REAUTH       ACI_FO_REAUTH 
#define OCI_FO_BEGIN        ACI_FO_BEGIN 
#define OCI_FO_ERROR        ACI_FO_ERROR 
/*---------------------------------------------------------------------------*/

/*------------------------ Fail Over Callback Return Codes ------------------*/
#define OCI_FO_RETRY        ACI_FO_RETRY 
/*---------------------------------------------------------------------------*/

/*------------------------- Fail Over Types ---------------------------------*/
#define OCI_FO_NONE           ACI_FO_NONE
#define OCI_FO_SESSION        ACI_FO_SESSION 
#define OCI_FO_SELECT         ACI_FO_SELECT 
#define OCI_FO_TXNAL          ACI_FO_TXNAL 
#define OCI_FO_AUTO           ACI_FO_AUTO  
/*---------------------------------------------------------------------------*/
...
#define OCI_TYPECODE_REAL			ACI_TYPECODE_REAL
#define OCI_TYPECODE_DOUBLE			ACI_TYPECODE_DOUBLE
#define OCI_TYPECODE_BFLOAT			ACI_TYPECODE_BFLOAT
#define OCI_TYPECODE_BDOUBLE		ACI_TYPECODE_BDOUBLE
#define OCI_TYPECODE_FLOAT			ACI_TYPECODE_FLOAT
#define OCI_TYPECODE_NUMBER			ACI_TYPECODE_NUMBER
#define OCI_TYPECODE_DECIMAL		ACI_TYPECODE_DECIMAL
#define OCI_TYPECODE_UNSIGNED8		ACI_TYPECODE_UNSIGNED8
...
#define OCI_TYPECODE_INTEGER		ACI_TYPECODE_INTEGER
#define OCI_TYPECODE_RAW			ACI_TYPECODE_RAW
#define OCI_TYPECODE_PTR			ACI_TYPECODE_PTR
#define OCI_TYPECODE_VARCHAR2		ACI_TYPECODE_VARCHAR2
#define OCI_TYPECODE_CHAR			ACI_TYPECODE_CHAR
#define OCI_TYPECODE_VARCHAR		ACI_TYPECODE_VARCHAR
#define OCI_TYPECODE_MLSLABEL		ACI_TYPECODE_MLSLABEL
#define OCI_TYPECODE_VARRAY			ACI_TYPECODE_VARRAY
#define OCI_TYPECODE_TABLE			ACI_TYPECODE_TABLE
#define OCI_TYPECODE_OBJECT			ACI_TYPECODE_OBJECT
#define OCI_TYPECODE_OPAQUE			ACI_TYPECODE_OPAQUE
#define OCI_TYPECODE_NAMEDCOLLECTION  ACI_TYPECODE_NAMEDCOLLECTION
#define OCI_TYPECODE_BLOB			ACI_TYPECODE_BLOB
#define OCI_TYPECODE_BFILE			ACI_TYPECODE_BFILE
#define OCI_TYPECODE_CLOB			ACI_TYPECODE_CLOB
#define OCI_TYPECODE_CFILE			ACI_TYPECODE_CFILE
...
#define OCI_TYPECODE_INTERVAL_YM	ACI_TYPECODE_INTERVAL_YM
#define OCI_TYPECODE_INTERVAL_DS	ACI_TYPECODE_INTERVAL_DS
#define OCI_TYPECODE_UROWID			ACI_TYPECODE_UROWID


#define OCI_TYPECODE_OTMFIRST		ACI_TYPECODE_OTMFIRST
#define OCI_TYPECODE_OTMLAST		ACI_TYPECODE_OTMLAST
#define OCI_TYPECODE_SYSFIRST		ACI_TYPECODE_SYSFIRST
#define OCI_TYPECODE_SYSLAST		ACI_TYPECODE_SYSLAST
#define OCI_TYPECODE_PLS_INTEGER	ACI_TYPECODE_PLS_INTEGER

/* the following are PL/SQL-only internal. They should not be used */
#define OCI_TYPECODE_ITABLE			ACI_TYPECODE_ITABLE
#define OCI_TYPECODE_RECORD			ACI_TYPECODE_RECORD
#define OCI_TYPECODE_BOOLEAN		ACI_TYPECODE_BOOLEAN
...
#define OCI_TYPECODE_NCHAR			ACI_TYPECODE_NCHAR
#define OCI_TYPECODE_NVARCHAR2		ACI_TYPECODE_NVARCHAR2
#define OCI_TYPECODE_NCLOB			ACI_TYPECODE_NCLOB
...
/* To indicate error has to be taken from error handle - reserved for
   sqlplus use */
#define OCI_TYPECODE_ERRHP			ACI_TYPECODE_ERRHP


#define OCITypeParamMode			ACITypeParamMode
#define OCI_TYPEPARAM_IN			ACI_TYPEPARAM_IN
#define OCI_TYPEPARAM_OUT			ACI_TYPEPARAM_OUT
#define OCI_TYPEPARAM_INOUT			ACI_TYPEPARAM_INOUT
#define OCI_TYPEPARAM_BYREF			ACI_TYPEPARAM_BYREF
#define OCI_TYPEPARAM_OUTNCPY		ACI_TYPEPARAM_OUTNCPY
#define OCI_TYPEPARAM_INOUTNCPY		ACI_TYPEPARAM_INOUTNCPY


   /* only type methods */
#define OCI_ATTR_ENCAPSULATION             ACI_ATTR_ENCAPSULATION        /* encapsulation level */
#define OCI_ATTR_IS_SELFISH                ACI_ATTR_IS_SELFISH             /* method selfish */
#define OCI_ATTR_IS_VIRTUAL                ACI_ATTR_IS_VIRTUAL                    /* virtual */
#define OCI_ATTR_IS_INLINE                 ACI_ATTR_IS_INLINE                     /* inline */
#define OCI_ATTR_IS_CONSTANT               ACI_ATTR_IS_CONSTANT                   /* constant */
#define OCI_ATTR_HAS_RESULT                ACI_ATTR_HAS_RESULT                 /* has result */
#define OCI_ATTR_IS_CONSTRUCTOR            ACI_ATTR_IS_CONSTRUCTOR                /* constructor */
#define OCI_ATTR_IS_DESTRUCTOR             ACI_ATTR_IS_DESTRUCTOR                 /* destructor */
#define OCI_ATTR_IS_OPERATOR               ACI_ATTR_IS_OPERATOR                   /* operator */
#define OCI_ATTR_IS_MAP                    ACI_ATTR_IS_MAP               /* a map method */
#define OCI_ATTR_IS_ORDER                  ACI_ATTR_IS_ORDER               /* order method */
#define OCI_ATTR_IS_RNDS                   ACI_ATTR_IS_RNDS  /* read no data state method */
#define OCI_ATTR_IS_RNPS                   ACI_ATTR_IS_RNPS      /* read no process state */
#define OCI_ATTR_IS_WNDS                   ACI_ATTR_IS_WNDS /* write no data state method */
#define OCI_ATTR_IS_WNPS                   ACI_ATTR_IS_WNPS     /* write no process state */


/* for inheritance - part 2 */
#define OCI_ATTR_IS_FINAL_TYPE             ACI_ATTR_IS_FINAL_TYPE            /* is final type ? */
#define OCI_ATTR_IS_INSTANTIABLE_TYPE      ACI_ATTR_IS_INSTANTIABLE_TYPE     /* is instantiable type ? */
#define OCI_ATTR_IS_FINAL_METHOD           ACI_ATTR_IS_FINAL_METHOD          /* is final method ? */
#define OCI_ATTR_IS_INSTANTIABLE_METHOD    ACI_ATTR_IS_INSTANTIABLE_METHOD   /* is instantiable method ? */
#define OCI_ATTR_IS_OVERRIDING_METHOD      ACI_ATTR_IS_OVERRIDING_METHOD     /* is overriding method ? */

/* for schemas */
#define OCI_ATTR_LIST_OBJECTS              ACI_ATTR_LIST_OBJECTS  /* list of objects in schema */

/* for database */
#define OCI_ATTR_NCHARSET_ID               ACI_ATTR_NCHARSET_ID                /* char set id */
#define OCI_ATTR_LIST_SCHEMAS              ACI_ATTR_LIST_SCHEMAS            /* list of schemas */
#define OCI_ATTR_MAX_PROC_LEN              ACI_ATTR_MAX_PROC_LEN       /* max procedure length */
#define OCI_ATTR_MAX_COLUMN_LEN            ACI_ATTR_MAX_COLUMN_LEN     /* max column name length */
#define OCI_ATTR_CURSOR_COMMIT_BEHAVIOR    ACI_ATTR_CURSOR_COMMIT_BEHAVIOR     /* cursor commit behavior */
#define OCI_ATTR_MAX_CATALOG_NAMELEN       ACI_ATTR_MAX_CATALOG_NAMELEN         /* catalog namelength */
#define OCI_ATTR_CATALOG_LOCATION          ACI_ATTR_CATALOG_LOCATION           /* catalog location */
#define OCI_ATTR_SAVEPOINT_SUPPORT         ACI_ATTR_SAVEPOINT_SUPPORT          /* savepoint support */
#define OCI_ATTR_NOWAIT_SUPPORT            ACI_ATTR_NOWAIT_SUPPORT             /* nowait support */
#define OCI_ATTR_AUTOCOMMIT_DDL            ACI_ATTR_AUTOCOMMIT_DDL             /* autocommit DDL */
#define OCI_ATTR_LOCKING_MODE              ACI_ATTR_LOCKING_MODE               /* locking mode */


/*------------------------ Attributes for Rules objects ---------------------*/
#define OCI_ATTR_CONDITION                  ACI_ATTR_CONDITION            /* rule condition */
#define OCI_ATTR_COMMENT                    ACI_ATTR_COMMENT                   /* comment */
#define OCI_ATTR_VALUE                      ACI_ATTR_VALUE             /* Anydata value */
#define OCI_ATTR_EVAL_CONTEXT_OWNER         ACI_ATTR_EVAL_CONTEXT_OWNER        /* eval context owner */
#define OCI_ATTR_EVAL_CONTEXT_NAME          ACI_ATTR_EVAL_CONTEXT_NAME         /* eval context name */
#define OCI_ATTR_EVALUATION_FUNCTION        ACI_ATTR_EVALUATION_FUNCTION        /* eval function name */
#define OCI_ATTR_VAR_TYPE                   ACI_ATTR_VAR_TYPE             /* variable type */
#define OCI_ATTR_VAR_VALUE_FUNCTION         ACI_ATTR_VAR_VALUE_FUNCTION   /* variable value function */
#define OCI_ATTR_VAR_METHOD_FUNCTION        ACI_ATTR_VAR_METHOD_FUNCTION  /* variable method function */
#define OCI_ATTR_ACTION_CONTEXT             ACI_ATTR_ACTION_CONTEXT            /* action context */
#define OCI_ATTR_LIST_TABLE_ALIASES         ACI_ATTR_LIST_TABLE_ALIASES     /* list of table aliases */
#define OCI_ATTR_LIST_VARIABLE_TYPES        ACI_ATTR_LIST_VARIABLE_TYPES    /* list of variable types */
#define OCI_ATTR_TABLE_NAME                 ACI_ATTR_TABLE_NAME                /* table name */
#define OCI_ATTR_LIST_ACTION_CONTEXT        ACI_ATTR_LIST_ACTION_CONTEXT

/* ACI_ATTR_CURSOR_COMMIT_BEHAVIOR */
#define OCI_CURSOR_OPEN   ACI_CURSOR_OPEN 
#define OCI_CURSOR_CLOSED ACI_CURSOR_CLOSED

/* ACI_ATTR_CATALOG_LOCATION */
#define OCI_CL_START ACI_CL_START
#define OCI_CL_END   ACI_CL_END

/* ACI_ATTR_SAVEPOINT_SUPPORT */
#define OCI_SP_SUPPORTED   ACI_SP_SUPPORTED
#define OCI_SP_UNSUPPORTED ACI_SP_UNSUPPORTED

/* ACI_ATTR_NOWAIT_SUPPORT */
#define OCI_NW_SUPPORTED   ACI_NW_SUPPORTED
#define OCI_NW_UNSUPPORTED ACI_NW_UNSUPPORTED

/* ACI_ATTR_AUTOCOMMIT_DDL */
#define OCI_AC_DDL		ACI_AC_DDL
#define OCI_NO_AC_DDL	ACI_AC_DDL

/* ACI_ATTR_LOCKING_MODE */
#define OCI_LOCK_IMMEDIATE ACI_LOCK_IMMEDIATE
#define OCI_LOCK_DELAYED   ACI_LOCK_DELAYED

/* --------- Attributes added to support server side session pool ---------- */
#define OCI_ATTR_DRIVER_NAME			ACI_ATTR_DRIVER_NAME                    /* Driver Name */
#define OCI_ATTR_CONNECTION_CLASS		ACI_ATTR_CONNECTION_CLASS
#define OCI_ATTR_PURITY					ACI_ATTR_PURITY
#define OCI_ATTR_DISTINGUISHED_NAME		ACI_ATTR_DISTINGUISHED_NAME
#define OCI_ATTR_DBOP					ACI_ATTR_DBOP



/* server attribute */
#define OCI_ATTR_RESERVED_37              ACI_ATTR_RESERVED_37

/*-------------------Attributes for OCI column security-----------------------*/
#define OCI_ATTR_NO_COLUMN_AUTH_WARNING   ACI_ATTR_NO_COLUMN_AUTH_WARNING
#define OCI_ATTR_XDS_POLICY_STATUS        ACI_ATTR_XDS_POLICY_STATUS

/* --------------- ip address attribute in environment handle -------------- */
#define OCI_ATTR_SUBSCR_IPADDR         ACI_ATTR_SUBSCR_IPADDR       /* ip address to listen on  */

#define OCI_ATTR_RESERVED_40           ACI_ATTR_RESERVED_40  
#define OCI_ATTR_RESERVED_41           ACI_ATTR_RESERVED_41
#define OCI_ATTR_RESERVED_42           ACI_ATTR_RESERVED_42
#define OCI_ATTR_RESERVED_43           ACI_ATTR_RESERVED_43

/* ------------- round trip callback attributes in the process  handle ----- */
#define OCI_ATTR_RESERVED_458          ACI_ATTR_RESERVED_458                       /* reserved */
#define OCI_ATTR_RESERVED_459          ACI_ATTR_RESERVED_459                       /* reserved */

/* support at most once transaction semantics */
#define OCI_ATTR_LTXID                     ACI_ATTR_LTXID     /* logical transaction id */

#define OCI_ATTR_LAST_LOGON_TIME_UTC       ACI_ATTR_LAST_LOGON_TIME_UTC /* Last Successful Logon Time */

#define OCI_ATTR_RESERVED_464              ACI_ATTR_RESERVED_464
#define OCI_ATTR_RESERVED_465              ACI_ATTR_RESERVED_465
#define OCI_ATTR_TRANSACTIONAL_TAF         ACI_ATTR_TRANSACTIONAL_TAF
#define OCI_ATTR_RESERVED_467              ACI_ATTR_RESERVED_467

/* SQL translation profile session attribute */
#define OCI_ATTR_SQL_TRANSLATION_PROFILE   ACI_ATTR_SQL_TRANSLATION_PROFILE

/* session handle attribute */
#define OCI_ATTR_MAX_OPEN_CURSORS          ACI_ATTR_MAX_OPEN_CURSORS
...
* is not.
*/
#define OCI_ATTR_ERROR_IS_RECOVERABLE      ACI_ATTR_ERROR_IS_RECOVERABLE

/* ONS specific private attribute  */
#define OCI_ATTR_RESERVED_473              ACI_ATTR_RESERVED_473 

/* Attribute to check if ILM Write Access Tracking is enabled or not */
#define OCI_ATTR_ILM_TRACK_WRITE           ACI_ATTR_ILM_TRACK_WRITE

/* Notification subscription failure callback and context */
#define	OCI_ATTR_SUBSCR_FAILURE_CBK        ACI_ATTR_SUBSCR_FAILURE_CBK
#define OCI_ATTR_SUBSCR_FAILURE_CTX        ACI_ATTR_SUBSCR_FAILURE_CTX

/* AQ JMS properties attributes */
#define OCI_ATTR_AQJMS_HEADER_PROP     ACI_ATTR_AQJMS_HEADER_PROP
#define OCI_ATTR_AQJMS_USER_PROP       ACI_ATTR_AQJMS_USER_PROP
#define OCI_ATTR_AQJMS_PROPERTIES      ACI_ATTR_AQJMS_PROPERTIES
#define OCI_ATTR_AQJMS_MSG_TYPE        ACI_ATTR_AQJMS_MSG_TYPE

/* A SQL translation profile with FOREIGN_SQL_SYNTAX attribute is set in the
* database session.
*/
#define OCI_ATTR_TRANS_PROFILE_FOREIGN     ACI_ATTR_TRANS_PROFILE_FOREIGN

/* is a transaction active on the session? */
#define OCI_ATTR_TRANSACTION_IN_PROGRESS   ACI_ATTR_TRANSACTION_IN_PROGRESS

/* FAN-HA private attribute */
#define OCI_ATTR_RESERVED_486              ACI_ATTR_RESERVED_486

/* reserved */
#define OCI_ATTR_RESERVED_487              ACI_ATTR_RESERVED_487

#define OCI_ATTR_RESERVED_488              ACI_ATTR_RESERVED_488
...
#define OCI_ATTR_RESERVED_491              ACI_ATTR_RESERVED_491

#define OCI_ATTR_RESERVED_492              ACI_ATTR_RESERVED_492

#define ACI_ATTR_RESERVED_492              492

#define ubig_ora  ubig_aci
#define sbig_ora  sbig_aci