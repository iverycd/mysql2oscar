...
typedef struct ACIXMLType ACIXMLType;


enum ACITypeParamMode
{
    /* PL/SQL starts this from 0 */
    ACI_TYPEPARAM_IN = 0,                                                /* in */
    ACI_TYPEPARAM_OUT,                                                  /* out */
    ACI_TYPEPARAM_INOUT,                                             /* in-out */
    ACI_TYPEPARAM_BYREF,              /* call by reference (implicitly in-out) */
    ACI_TYPEPARAM_OUTNCPY,                         /* OUT with NOCOPY modifier */
    ACI_TYPEPARAM_INOUTNCPY                     /* IN OUT with NOCOPY modifier */
};
typedef enum ACITypeParamMode ACITypeParamMode;
